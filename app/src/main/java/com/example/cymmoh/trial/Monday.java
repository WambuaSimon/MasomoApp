    ...
    public void addData() {
        button_add.setOnClickListener(new View.OnClickListener() {
                                          ...
                                          public void onClick(View v) {
                                              ...
                                              if (isInserted = true) {
                                                  Toast.makeText(Monday.this, "Data Inserted", Toast.LENGTH_SHORT).show();
                                              } else {
                                                  Toast.makeText(Monday.this, "Data not inserted", Toast.LENGTH_SHORT).show();

                                              }
                                              if(editText_unit.equals("")||editText_time.equals("")||editText_venue.equals("")||editText_lecturer.equals("")){

                                                  Toast.makeText(Monday.this,"Enter your schedule",Toast.LENGTH_LONG).show();
                                              }
    ...
    public void DeleteData(){
        button_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(deletedRows>0)
                    Toast.makeText(Monday.this, "Data Deleted", Toast.LENGTH_SHORT).show();
                else
                    Toast.makeText(Monday.this, "Data not Deleted", Toast.LENGTH_SHORT).show();
