 ...
 */
public class ThursdayDb extends SQLiteOpenHelper {
    public  static  final String DATABASE_NAME = "thursday_db";
    public  static  final String TABLE_NAME = "thursday_tbl";
    ...
    public ThursdayDb(Context context) {
